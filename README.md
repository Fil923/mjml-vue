...
So in order to create emails on the fly we created a library with `Vue` components.

This library is inspired by [mjml-react](https://github.com/Faire/mjml-react) by [Faire](https://github.com/Faire)
